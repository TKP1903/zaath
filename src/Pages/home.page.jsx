...
const HomePage = () => {
  return (
    <>
        <div>
            <div style={{background: "#020c2B"}} className="bg-pink-50 w-full md:fixed md:py-2">
                <Navbar />
            </div>
            <Carousels />
            <VideoComponent />
            <div style={{background: "#797F89"}} className="flex flex-col items-center justify-cecnter gap-10 pt-28 lg:px-44">
            ...
            <div className="flex flex-col items-center justify-cecnter gap-10 pt-28 lg:mx-44">
              <div className="flex flex-col items-center justify-center gap-4">
                <h1 className="text-4xl font-bold border-b border-yellow-600 pb-2">Our Clients</h1>
                <p className="text-md text-gray-400 w-3/4 text-center">FROM YOUR VISION TO REALITY!</p>
              </div>
                <Clients />
            </div>
        </div>
