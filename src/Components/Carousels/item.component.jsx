...
const ItemComponent = (props) => {
  return (
    <>
        <div style={{ height: "600px" }} className="hidden md:flex items-center justify-center w-full text-blue-color dark:text-gray-50">
          <div className="w-1/2 flex flex-col items-start justify-center gap-6">
            ...
            <p className="text-md lg:text-lg text-gray-500 w-5/6">{props.desctiption}</p>
          </div>
        ...
        <div style={{ height: "90%"}} className="flex flex-col md:hidden items-center justify-center relative pt-10 dark:text-gray-50">
          <div className="flex flex-col items-start justify-center gap-6 w-4/5">
            ...
            <p className="text-md text-gray-500 text-center">{props.desctiption}</p>
          </div>
          <div className="h-full">
