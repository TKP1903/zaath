...
const ContactHero = (props) => {
  return (
    <>
        <div style={{ background: "#020c2B"}} className="md:px-20 lg:px-44 bg-pink-50 flex flex-col md:flex-row items-center justify-center gap-10 md:py-36 lg:py-0 pt-8 lg:pt-28">
            <div className="flex flex-col items-start justify-center gap-6 md:w-1/2 px-3 text-gray-50">
